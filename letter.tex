...
\newcommand{\myAuthor}
{F. Nietzsche} %<{"type": "text", "description": "Author"}>
\newcommand{\fromLines}{
  \small
  {
    \textbf{\myAuthor}
    %<{"type": "list", "description": "From lines"}
    \fromItem{Artillerieregiment, 8. Batt.}%<{"type": "text", "description": "From"}>
...
\newcommand{\toLines}{
  ...
  %<{"type": "list", "description": "To lines"}
    \toItem{Carl Freiherr von Gersdorff} %<{"type": "text", "description": "To"}>
...
\newcommand{\mySubject}
{%
\customSubject{My life as a soldier} %<{"type": "text", "description": "Subject (optional)", "deleteOnEmpty": "true"}>
}
...
\newcommand{\city}
{%
  {Naumburg}, %<{"type": "text", "description": "City (optional)", "deleteOnEmpty": "true"}>
}
\newcommand{\myDate}{%
  November 20th 2022%<{"type": "date", "description": "Date (optional)", "deleteOnEmpty": "true"}>
}
\newcommand{\myBody}
{
%<{"type": "textblock", "description": "Body"}
Dear Friend,
...
\begin{FlushRight}
  \signature{signature.pdf} %<{"type": "image", "description": "Signature image (optional)", "deleteOnEmpty": "true"}>
  \myAuthor
\end{FlushRight}
